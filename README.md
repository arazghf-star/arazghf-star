...
![Security](https://img.shields.io/badge/security-scanned-blue?style=flat-square)
...
![IaC](https://img.shields.io/badge/IaC-terraform-623CE4?style=flat-square)
![Security](https://img.shields.io/badge/tfsec-passed-success?style=flat-square)
...
![Serverless](https://img.shields.io/badge/serverless-AWS%20Lambda-orange?style=flat-square)
...
![Reusable](https://img.shields.io/badge/reusable-workflows-blue?style=flat-square)
...
graph LR
    ...
    B -->|Build & Test| C[Security Scan]
    C -->|Pass| D[Container Registry]
    D -->|Deploy| E[Kubernetes]
    E -->|Monitor| F[Observability Stack]
    F -->|Alerts| G[On-Call]
```
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=arazghf-star&show_icons=true&theme=radical)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=arazghf-star&layout=compact&theme=radical)
